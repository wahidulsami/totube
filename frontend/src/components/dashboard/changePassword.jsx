  ...
  <div className=" flex flex-col justify-center items-center
   p-4">
    <div className="w-full ">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-5 justify-center">
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2
                       rounded-md bg-red-600 text-white py-2 px-4 font-medium
          ...
          <button
            type="button"
            className="w-full sm:w-auto px-5 h-11 flex items-center justify-center
                       rounded-md cursor-pointer bg-gray-800 hover:bg-gray-700
      ...
      {/* Security Tips */}
      <div className="mt-8 p-5 bg-gray-800/30 border border-gray-700/30 rounded-xl backdrop-blur-sm shadow-inner">
