    ...
    <div className="flex items-center space-x-2">
      <input
        ...
        className="flex-1 px-4 py-2 bg-gray-900 border border-gray-700 rounded-l-full 
                   focus:outline-none focus:border-blue-500 placeholder-gray-400 text-sm"
      />
      <button className="px-4 py-2 bg-gray-800 border border-l-0 border-gray-700 rounded-r-full 
                         hover:bg-gray-700 transition-colors">
        <Search className="w-5 h-5" />
      </button>
        ...
        <div className="absolute top-full left-0 right-0 bg-black border-t border-gray-700 p-3 md:hidden z-40">
          <div className="flex items-center space-x-2">
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="flex-1 px-4 py-2 bg-gray-900 border border-gray-700 rounded-l-full focus:outline-none focus:border-blue-500 placeholder-gray-400"
            />
...
/* Helpers */
function DropdownItem({ icon, text, rightText, danger }) {
  return (
    <button
    ...
    >
      ...
      {!rightText && <ChevronRight className="w-4 h-4" />}
    </button>
  );
}
